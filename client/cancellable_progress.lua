...
Citizen.CreateThread(function()
    AddTextEntry('RaySist_CANCEL', "~" .. Config.Keys.CANCEL.label .. "~ " .. Config.Text.CANCEL)
end)
...
function CancellableProgress(time, animDict, animName, flag, finish, cancel, opts)
    ...
    while true do
        ...
        DisplayHelpTextThisFrame('RaySist_CANCEL', true)
...
function StartCancellableProgressBar(time)
    ...
    Citizen.CreateThread(function()
        while IsProgressbarDisplayed and curProgressWidth < 1.0 do
            ...
            SetTextEntry("RaySist_CF_FIXING")
            DrawText(0.5, 0.883)
        end
    end)
end
